...
let client;
export const fileSystemProvider = (_services) => ({
...
export function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('orunmilang.run', async () => {
...
function startLanguageClient(context) {
    ...
    const client = new LanguageClient('orunmilang', 'orunmilang', serverOptions, clientOptions);
